...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  ChangeCredRequestModel credRequestModel = new ChangeCredRequestModel();
  @override
                        ...
                        new Flexible(
                          child: Container(
                            ...
                            child: new TextField(
                              ...
                              decoration: InputDecoration(
                                labelText: validPassword ? passwordLabel : null,
                        ...
                        child: FlatButton(
                            ...
                            onPressed: () {
                              ...
                              if (validUsername && validPassword) {
                                credRequestModel.username =
                                    usernamecontroller.text;
                                credRequestModel.password =
                                    passwordcontroller.text;
                                apiService
                                    .changeCredential(credRequestModel)
                                    .then((value) {
                                  if (value.changed) {
